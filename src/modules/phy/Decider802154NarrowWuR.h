/*
 * Decider802154NarrowWuR.h
 *
 *  Created on: 28 août 2020
 *      Author: asus
 */

#ifndef DECIDER802154NARROWWUR_H_
#define DECIDER802154NARROWWUR_H_
 ...
 */
class MIXIM_API Decider802154NarrowWuR: public BaseDecider {
public:
...
public:
     ...
     */
    Decider802154NarrowWuR( DeciderToPhyInterface* phy
                       , double                 sensitivity
                       , int                    myIndex
                       , bool                   debug )
    ...
    virtual ~Decider802154NarrowWuR() {};
};

#endif /* DECIDER802154NARROWWUR_H_ */
